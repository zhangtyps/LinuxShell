...
check_path=/home/zhangtianyu/curl_Alarm/shell_temp/yangguang.txt
#access_path为超巴抓取文本的放置位置，此文本和上面txt_path做比对
access_path=/home/zhangtianyu/curl_Alarm/shell_temp/access_yg.log
#for_path为存放检测结果的文本位置
for_path=/home/zhangtianyu/curl_Alarm/shell_temp/output_yg.log
#邮件相关参数
FILE_DEMO=/home/zhangtianyu/curl_Alarm/shell_temp/yg_mail.log
FILE=/var/log/yg_checkhost_sendmail.txt
SUBJECT="阳光host代理检测告警"
...
#发送邮件模块
MAIL_PATH=/home/zhangtianyu/mail.sh
